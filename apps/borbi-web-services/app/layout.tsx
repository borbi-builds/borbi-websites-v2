...
export const metadata: Metadata = {
  title: 'Borbi Website Services — The Showcase',
  description: 'Websites that make people stop scrolling. High-converting, beautifully crafted.',
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className="dark" style={{ '--accent-primary': '#A855F7' } as React.CSSProperties}>
      <head>
        <link
